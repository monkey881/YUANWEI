...
<a href="user.php?act=taocan" <?php if ($this->_var['action'] == 'taocan'): ?>class="curs"<?php endif; ?>><img src="themes/default/images/u1.gif"> <?php echo $this->_var['lang']['label_taocan']; ?></a>
...
<a href="user.php?act=peisong" <?php if ($this->_var['action'] == 'peisong'): ?>class="curs"<?php endif; ?>><img src="themes/default/images/u1.gif"> <?php echo $this->_var['lang']['label_peisong']; ?></a>
