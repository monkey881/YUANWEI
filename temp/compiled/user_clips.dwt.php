...
<div class="block clearfix">
  ...
  <tr>
    <td width="150" rowspan="4" valign="top"><img src="<?php echo $this->_var['info']['userpic']; ?>" width="150" height="150" alt="" /></td>
    <td  valign="top"> <font class="f5"><b class="f4"><?php echo $this->_var['info']['username']; ?></b> <?php echo $this->_var['lang']['welcome_to']; ?> <?php echo $this->_var['info']['shop_name']; ?>！</font><br />
          <div class="blank"></div>
  ...
  <tr>
    <td >订单提醒：<a href="#">待处理订单()</a> <a href="#">待评价订单()</a></td>
  </tr>
  <tr>
    <td >待设配送：<a href="#">二人单月（4月16日）</a></td>
  </tr>
  <tr>
    <td>我的关注：<a href="#">新上菜品(0) </a> <a href="#">促销活动(0)</a></td>
  </tr>
</table>
