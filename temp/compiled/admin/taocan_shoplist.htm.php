...
?>
  ...
  <div class="select"><input name="num<?php echo $this->_var['goods']['goods_id']; ?>" type="text" id="num<?php echo $this->_var['goods']['goods_id']; ?>" value="<?php echo $this->_var['goods']['num']; ?>" size="8" />
  
  
  <input name="checkboxes[]" type="checkbox" value="<?php echo $this->_var['goods']['goods_id']; ?>"/>
...
<?php if ($this->_var['act'] != 'addshop'): ?>
  <input name="act" type="hidden" value="updata" />
  <?php else: ?>
   <input name="act" type="hidden" value="saveshop" />
   <?php endif; ?>
  全选<input onclick='listTable.selectAll(this, "checkboxes")' type="checkbox">  删除<input name="chkDel" type="checkbox" id="chkDel" value="1"> 
  <input type="submit" value="更新" id="btnSubmit" name="btnSubmit" class="button" />   <!--<input type="button" value="添加商品" id="btnSubmit2" name="btnSubmit2" class="button" onclick="showPopWin('goods_taocan.php?act=list&tid=<?php echo $this->_var['tid']; ?>', 900, 600, null);"/>
</div>-->
</form>
