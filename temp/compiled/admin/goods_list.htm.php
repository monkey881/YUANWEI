...
?>
  <tr>
    ...
    <?php endif; ?>
    <td align="center">
    <?php if ($this->_var['is_taocan']): ?>
     <a href="goods_taocan.php?act=shoplist&id=<?php echo $this->_var['goods']['goods_id']; ?>"  title="管理套餐商品"><img src="images/icon_priv.gif" width="16" height="16" border="0" /></a>
      <?php endif; ?>
