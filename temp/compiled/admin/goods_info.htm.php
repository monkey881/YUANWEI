    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            <td class="label">是否套餐</td>
            <td><input type="checkbox" name="isTaocan" id="isTaocan" />
            <label for="isTaocan">配送下限：</label><input class="text" size="10" name="psWeight" id="psWeight" />
            千克</td>
          </tr>
          <tr>
