...
function eyloadcart()
{
	Ajax.call('flow.php?step=ajax_cart', '', eyloadcartResponse, 'POST', 'JSON');
}
...
function eyloadcartResponse(result)
{
  ...
  {
     document.getElementById('eycart').innerHTML = result.content;
   	document.getElementById('car_good_num').innerHTML =result.message;
   vv('cat_ul');
  }
}
